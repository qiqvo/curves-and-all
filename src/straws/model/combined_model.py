...
class CombinedModel(Model):
    def __init__(self, models, correlation_provider):
        super().__init__(sum([m.dimension for m in models]), 
    ...
    def apply_correlations(self, dW):
        corr = self.correlation_provider.get_corr_matrix([m.id for m in self.models])
